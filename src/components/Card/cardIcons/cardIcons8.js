...
import icon1 from './product8/Velador.svg'
import icon2 from './product8/Camara.svg'
import icon3 from './product8/Parlante Bluetooth.svg'
import icon4 from './product8/Telefono.svg'
import icon5 from './product8/Respirador CPAP.svg'
import icon6 from './product8/Manta electrica.svg'
